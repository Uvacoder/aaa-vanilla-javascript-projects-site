      ...
      <div className="hero-center">
        <div className="hero-title">
          ...
          <p>
            ...
            <span> Javascript </span> is no exception. Solidify your knowledge
            of Javascript by creating these cool projects.
          </p>
          <a
            href="https://www.udemy.com/course/javascript-tutorial-for-beginners-w/?referralCode=DD9FA6C0D976918D3E1C"
            target="_blank"
            rel="noreferrer"
        ...
        <img src={heroImg2} alt="web development" className="img" />
      </div>
    </Wrapper>
  )
}
